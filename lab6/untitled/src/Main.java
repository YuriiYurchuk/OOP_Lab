...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        LibraryMember member2 = new LibraryMember(2, "Dyadchenko", "Ivanka", "Ivanivna", "+380987654321", "St. Volitsa 43", books1, LocalDate.of(2024, 2, 27), false, "Female", "dyadchenko@example.com");
        LibraryMember member3 = new LibraryMember("Gordienko", "Dmytro", "Dmytrovych");
        LibraryMember member4 = new LibraryMember(member2);
        LibraryMember member5 = new LibraryMember(3, "Belous", "Nina", "Ihorivna", "+380789123456", "St. Mountain 58", books4, LocalDate.of(2021,1,1), false, "Female", "belous@example.com");
        LibraryMember member6 = new LibraryMember(4, "Tymoshchenko", "Ivan", "Ivanovich", "+380123456789", "St. Main 124", books1, LocalDate.of(2022,12,1), true, "Male", "tymoshchenko@example.com");
